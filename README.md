...
- `simulator-concurrent/`: Contains the implementations of concurrent lazy promotion techniques
...
# concurrent
./_build/bin/cachesim fifo <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
...
# concurrent
./_build/bin/cachesim lru <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
...
# concurrent
./_build/bin/cachesim lru-prob -e prob=0.5 <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
...
# concurrent
./_build/bin/cachesim lru-delay -e delay-time=0.2 <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
...
# concurrent
./_build/bin/cachesim batch -e batch-size=0.5 <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
...
# concurrent
./_build/bin/cachesim clock -e n_bit_counter=1 <cache_size> --ignore-obj-size 1 --num-thread <thread_count>
```
